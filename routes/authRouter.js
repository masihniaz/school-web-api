...
function routes(User) {
  ...
  authRouter.route('/auth/login')
    .post(loginValidation, async(req, res) => {
      ...
      isMatch = await isPasswordValid(req.body.password, user.password);
      ...
      if(!isMatch) {
        ...
        const jwtPayloadToSign = { id, name, email, role };
...
isPasswordValid = (candidatePassword, hashedPassword) => {
